"""
Baseline Phase Visualization
============================

Visualize the phase of Stokes I visibilities for a selected baseline
in a LOFAR Measurement Set (MS).

- Loads a Measurement Set and selects a baseline (ANTENNA1, ANTENNA2).
- Computes Stokes I visibility phase.
- Plots a 2D phase image (frequency vs. time).
- Extracts and plots 1D slices:
    * Phase vs. frequency at a fixed time.
    * Phase vs. time at a fixed frequency.
