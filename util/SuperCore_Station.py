"""
SuperCore Station Parset Generator
==================================

Generates a DP3 parset file ("apply.parset") that combines all LOFAR
core stations (CS*) into a single virtual SuperCore station (ST001)
"""
